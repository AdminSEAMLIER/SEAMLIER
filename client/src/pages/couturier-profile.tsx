      ...
      <header className="border-b border-gray-100 sticky top-0 z-50 bg-white">
        <div className="w-full px-4 md:px-8 py-3 md:py-4 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            <LanguageToggle />
            <Link href="/connexion">
              <Button variant="ghost" size="sm" className="text-[#722F37] px-2 lg:px-4 text-sm lg:text-base">
                {t('landing.login')}
              </Button>
            </Link>
            <Link href="/inscription-particulier">
              <Button size="sm" className="bg-[#722F37] hover:bg-[#5a252c] text-white px-2 lg:px-4 text-sm lg:text-base">
                {t('landing.signup')}
              </Button>
            </Link>
          </div>
