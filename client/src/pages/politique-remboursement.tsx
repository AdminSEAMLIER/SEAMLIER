    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="space-y-8">
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              <Shield className="h-5 w-5 text-[#601B28]" />
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <ul className="space-y-3 ml-4">
                <li className="flex items-start gap-2">
                  <span className="w-2 h-2 rounded-full bg-[#601B28] mt-2 shrink-0" />
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={step.n} className="flex gap-4">
                  <div className="w-8 h-8 rounded-full bg-[#601B28] text-white flex items-center justify-center text-sm font-bold shrink-0 mt-0.5">
                    {step.n}
                  </div>
                  <div>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              <a href="mailto:contact@seamlier.fr" className="text-[#601B28] hover:underline font-medium">
                contact@seamlier.fr
              </a>
              <br />
      ...
      <footer className="bg-white border-t border-gray-100 py-8 px-4 mt-12">
        <div className="max-w-4xl mx-auto flex flex-wrap justify-center gap-6 text-sm text-gray-400">
          ...
          <Link href="/cgu" className="hover:text-[#601B28]">CGU</Link>
