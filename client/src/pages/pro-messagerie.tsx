...
export default function ProMessagerie() {
  ...
  return (
    <div className="min-h-screen pb-20 lg:pb-8 bg-white">
      <div className="bg-gray-50 border-b border-gray-100 lg:hidden">
      ...
      <div className="lg:flex lg:h-[calc(100vh-4rem)]">
        <div className="lg:w-80 lg:border-r border-gray-100 bg-white">
          <div className="p-4 border-b border-gray-100 hidden lg:block">
            <h2 className="font-serif text-xl text-[#722F37] mb-3">{t('nav.messaging')}</h2>
          ...
          <div className="divide-y divide-gray-100">
            {mockConversations.map((conv) => (
              <div
                ...
                className={`p-4 cursor-pointer hover:bg-gray-50 transition-colors ${selectedConv.id === conv.id ? 'bg-gray-50' : ''}`}
              ...
              >
                <div className="flex gap-3">
                  ...
                  {conv.unread > 0 && (
                    <span className="w-5 h-5 rounded-full bg-[#722F37] text-white text-xs flex items-center justify-center">
                      {conv.unread}
                    </span>
                  )}
                </div>
        ...
        <div className="hidden lg:flex flex-col flex-1">
          ...
          <div className="p-4 border-t border-gray-100 bg-white">
            <div className="flex gap-2">
              ...
              />
              <Button className="bg-[#722F37] hover:bg-[#5a252c]" data-testid="button-send">
