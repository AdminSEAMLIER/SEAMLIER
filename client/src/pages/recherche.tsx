    ...
    <div className="min-h-screen bg-white">
      <header className="border-b border-gray-100 sticky top-0 z-50 bg-white">
        <div className="w-full px-4 md:px-8 py-3 md:py-4 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <Link href="/">
              <Button variant="ghost" size="icon" className="text-[#601B28]">
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-8 lg:py-12">
          <h1 className="font-serif text-2xl lg:text-4xl text-[#601B28] mb-2">
            {t('recherche.title')}
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-xl">
            ...
            <Button 
              className="h-12 px-6 bg-[#601B28] hover:bg-[#4E1522] text-white"
            ...
            {cities.map((city) => (
              <Button
                ...
                className={activeFilter.toLowerCase() === city.toLowerCase() 
                  ? "bg-[#601B28] hover:bg-[#4E1522] text-white" 
        ...
        {tailorsLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <div className="max-w-md mx-auto p-6 bg-[#f8f5f5] rounded-lg">
              <h3 className="font-serif text-lg text-[#601B28] mb-2">
              ...
              <Link href="/professionnel">
                <Button className="bg-[#601B28] hover:bg-[#4E1522] text-white">
