...
import { ArrowLeft, Mail, Lock, Eye, EyeOff, Loader2, Scissors } from "lucide-react";
...
export default function ConnexionProfessionnel() {
    ...
    try {
      ...
      if (response.ok && data) {
        if (data.role !== 'tailor') {
          ...
          toast({
            title: t('auth.error'),
            description: t('auth.wrongPortalPro'),
            variant: "destructive",
          });
          return;
        }
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-none shadow-xl bg-white">
            <CardContent className="p-8">
              <form onSubmit={handleLogin} className="space-y-5" data-testid="form-login-pro">
