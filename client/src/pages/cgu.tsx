    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-10 lg:py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#722F37] mb-3">1. Objet</h2>
            <p className="text-gray-600 leading-relaxed">
              Les présentes Conditions Générales d'Utilisation (CGU) définissent les règles d'accès et d'utilisation de la plateforme SEAMLIER, accessible à l'adresse <a href="https://www.seamlier.fr" className="text-[#722F37] hover:underline">www.seamlier.fr</a>, exploitée par la société SEAMLIER SAS. Toute utilisation de la plateforme implique l'acceptation pleine et entière des présentes CGU.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-[#722F37] mb-3">2. Description du service</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#722F37] mb-3">3. Inscription et compte utilisateur</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#722F37] mb-3">4. Obligations des utilisateurs</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#722F37] mb-3">5. Obligations des artisans</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#722F37] mb-3">6. Propriété intellectuelle</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#722F37] mb-3">7. Limitation de responsabilité</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#722F37] mb-3">8. Suspension et résiliation</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#722F37] mb-3">9. Données personnelles</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#722F37] mb-3">10. Droit applicable et juridiction</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#722F37] mb-3">11. Modification des CGU</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <p className="text-gray-500 text-sm">
              Contact : <a href="mailto:contact@seamlier.fr" className="text-[#722F37] hover:underline">contact@seamlier.fr</a> — 
              SEAMLIER SAS, France
            </p>
          </section>
      ...
      <footer className="bg-white border-t border-gray-100 py-8 px-4 mt-12">
        <div className="max-w-4xl mx-auto flex flex-wrap justify-center gap-6 text-sm text-gray-400">
          ...
          <Link href="/politique-remboursement" className="hover:text-[#722F37]">Remboursement</Link>
